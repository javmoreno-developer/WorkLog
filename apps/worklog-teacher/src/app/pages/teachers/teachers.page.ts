...
export class TeachersPage implements OnInit {
   ...
   tableButtons = [
    {icon: "", text: "Restablecer contraseña", fun: "onReset", cssClass: "see_entries_btn", popover: false,},
   ]
   ...
   // Show general modal
   async presentModal(cellUpd: Object | null, event: any, type: string, ...extras: any) {
  ...
  resetPass(param: any,id: any) {
   ...
   resetModal(param: any) {
    console.log(param.data.idUser)
    this.presentModal(null,null,'reset',param.data.idUser)
  }
 }